...
<fieldset id="pal_project_legend" class="tl_tbox block<?php echo $this->projectClass; ?>">
<legend onclick="AjaxRequest.toggleFieldset(this, 'project_legend', 'tl_tasks')"><?php echo $this->projectLabel; ?></legend>
<div class="w50">
  <h3><?php echo $this->project->generateLabel(); ?></h3>
  <?php echo $this->project->generateWithError(); ?> 
<?php if ($this->project->help): ?>
  <p class="tl_help tl_tip"><?php echo $this->project->help; ?></p>
<?php endif; ?>
</div>
</fieldset>
...
<fieldset id="pal_assign_legend" class="tl_box block<?php echo $this->categoryClass; ?>">
<legend onclick="AjaxRequest.toggleFieldset(this, 'category_legend', 'tl_tasks')"><?php echo $this->categoryLabel; ?></legend>
<div class="w50">
  <h3><?php echo $this->tasktype->generateLabel(); ?></h3>
  <?php echo $this->tasktype->generateWithError(); ?> 
<?php if ($this->tasktype->help): ?>
  <p class="tl_help tl_tip"><?php echo $this->tasktype->help; ?></p>
<?php endif; ?>
</div>
<div class="w50">
  <h3><?php echo $this->priority->generateLabel(); ?></h3>
  <?php echo $this->priority->generateWithError(); ?> 
<?php if ($this->priority->help): ?>
  <p class="tl_help tl_tip"><?php echo $this->priority->help; ?></p>
<?php endif; ?>
</div>
</fieldset>
...
<input type="submit" name="saveAndClose" id="saveAndClose" class="tl_submit" accesskey="s" value="<?php echo $this->submitAndClose; ?>" />
</div>
